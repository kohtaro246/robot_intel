...
train_set1 = load_dataset(
    "./cifar-10-python/noise_25/data_batch_1")["data"]
train_class1 = load_dataset(
    "./cifar-10-python/noise_25/data_batch_1")["labels"]
train_set2 = load_dataset(
    "./cifar-10-python/noise_25/data_batch_2")["data"]
train_class2 = load_dataset(
    "./cifar-10-python/noise_25/data_batch_2")["labels"]
train_set3 = load_dataset(
    "./cifar-10-python/noise_25/data_batch_3")["data"]
train_class3 = load_dataset(
    "./cifar-10-python/noise_25/data_batch_3")["labels"]
train_set4 = load_dataset(
    "./cifar-10-python/noise_25/data_batch_4")["data"]
train_class4 = load_dataset(
    "./cifar-10-python/noise_25/data_batch_4")["labels"]
train_set5 = load_dataset(
    "./cifar-10-python/noise_25/data_batch_5")["data"]
train_class5 = load_dataset(
    "./cifar-10-python/noise_25/data_batch_5")["labels"]
...
def back_prop(tmps, minibatch_class):
    ...
    derivs["da" + str(layer_num-1)], derivs["dw" + str(layer_num)], derivs["db" +
                                                                           str(layer_num)] = back_prop_step(None, tmps[-1], "softmax", 0.0, minibatch_class)
    for i in reversed(range(layer_num-1)):
        da_prev, dw, db = back_prop_step(
            derivs["da" + str(i+1)], tmps[i], "relu", 0.0, minibatch_class)
...
path = './costs/kadai_0_25.txt'
f = open(path,'w')
f.write(str(costs[-1]))
f.close

with open('./params_0_25.pickle', mode='wb') as f:
...
fig.savefig("./result/cost_0_25.png")
# plt.show()
...
plt.ylabel('accuracy')
plt.legend(loc="lower right")
fig.savefig("./result/accuracy_0_25.png")
# plt.show()
