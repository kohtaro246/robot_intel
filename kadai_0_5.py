...
train_set1 = load_dataset(
    "./cifar-10-python/noise_5/data_batch_1")["data"]
train_class1 = load_dataset(
    "./cifar-10-python/noise_5/data_batch_1")["labels"]
train_set2 = load_dataset(
    "./cifar-10-python/noise_5/data_batch_2")["data"]
train_class2 = load_dataset(
    "./cifar-10-python/noise_5/data_batch_2")["labels"]
train_set3 = load_dataset(
    "./cifar-10-python/noise_5/data_batch_3")["data"]
train_class3 = load_dataset(
    "./cifar-10-python/noise_5/data_batch_3")["labels"]
train_set4 = load_dataset(
    "./cifar-10-python/noise_5/data_batch_4")["data"]
train_class4 = load_dataset(
    "./cifar-10-python/noise_5/data_batch_4")["labels"]
train_set5 = load_dataset(
    "./cifar-10-python/noise_5/data_batch_5")["data"]
train_class5 = load_dataset(
    "./cifar-10-python/noise_5/data_batch_5")["labels"]
...
path = './costs/kadai_0_5.txt'
f = open(path,'w')
f.write(str(costs[-1]))
f.close

with open('./params_0_5.pickle', mode='wb') as f:
...
fig.savefig("./result/cost_0_5.png")
# plt.show()
...
plt.ylabel('accuracy')
plt.legend(loc="lower right")
fig.savefig("./result/accuracy_0_5.png")
# plt.show()
