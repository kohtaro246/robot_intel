...
def learn(train_set, train_class, learning_rate, batch_num, epochs):
    ...
    # initialize params
    params = init_params([train_set.shape[0], 85, 5])
...
path = './costs/kadai_0_0_2_85.txt'
f = open(path,'w')
f.write(str(costs[-1]))
f.close

with open('./params_0_0_2_85.pickle', mode='wb') as f:
...
fig.savefig("./result/cost_0_0_2_85.png")
# plt.show()
...
plt.ylabel('accuracy')
plt.legend(loc="lower right")
fig.savefig("./result/accuracy_0_0_2_85.png")
# plt.show()
